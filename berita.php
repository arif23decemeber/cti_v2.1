...
<body class="dark:bg-gray-800">
    ...
    <div class="bg-white dark:bg-gray-800">
        <div class="container xl:pt-10 md:pt-20 pt-20 pb-7 p-4 m-auto xl:mt-20 mt-7">
            <div class="grid gap-6 mb-6 md:grid-cols-3 xl:grid-cols-4 sm:grid-cols-2 grid-cols-1">
                <div class="max-w-sm bg-white border border-gray-200 rounded-lg shadow-md dark:bg-gray-900 dark:border-gray-700">
                    <a href="#">
                        <img class="rounded-t-lg" src="news.png" alt="" />
                    </a>
                    <div class="p-5">
                        <a href="#">
                        ...
                        <a href="#" class="inline-flex items-center px-5 py-2.5 text-sm font-medium text-center text-white bg-teal-500 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                            Read more
                        </a>
                    </div>
                </div>
